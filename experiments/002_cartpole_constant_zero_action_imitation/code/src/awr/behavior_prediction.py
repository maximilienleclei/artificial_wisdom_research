...
class ActionPredictionEvaluator:
    ...
    def evaluate(
        ...
        batched_population = BatchedMLPPopulation.from_genomes(genomes, self.device)
        ...
        if self._is_discrete:
            ...
            target_indices = torch.as_tensor(target_actions, dtype=torch.int64, device=self.device)
